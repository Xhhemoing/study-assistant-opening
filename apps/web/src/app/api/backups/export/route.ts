import { exportBackupForPrincipal } from "../../../../features/library/backup-service";
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    const result = await exportBackupForPrincipal(runtime, principal, await readBody(request));
