import { revealAnswerForPrincipal } from "../../../../../features/practice/practice-service";
...
export async function POST(
  ...
  try {
    ...
    const result = await revealAnswerForPrincipal(runtime, principal, id, await request.json());
